            ...
            @foreach(session('cart') as $id => $details)
                ...
                <tr>
                    ...
                    <td class="actions" data-th="">
                        <button class="btn btn-primary btn-sm update-cart" data-id="{{ $id }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
